          ...
          <main className="content fade-in">
            {errorMessage ? (
              ...
              <>
                ...
                {mountedTabs.has('sip') && <div style={{ display: currentView === 'sip' ? undefined : 'none' }}><SIPTracker currentMonth={currentMonth} currentYear={currentYear} activeBudgetMonth={activeBudgetMonth} onPortfolioUpdate={triggerRefresh} frozenSip={monthlySummary?.savings_sip} /></div>}
                {mountedTabs.has('stocks') && <div style={{ display: currentView === 'stocks' ? undefined : 'none' }}><StockTracker currentMonth={currentMonth} currentYear={currentYear} activeBudgetMonth={activeBudgetMonth} onPortfolioUpdate={triggerRefresh} onPricesRefreshed={() => setStockRefreshTick(t => t + 1)} frozenShares={monthlySummary?.savings_shares} /></div>}
